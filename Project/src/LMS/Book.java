...
public class Book {
    ...
    private static final AtomicInteger currentIdNumber = new AtomicInteger(0);     //This will be unique for every book, since it will be incremented when everytime when a book is created
